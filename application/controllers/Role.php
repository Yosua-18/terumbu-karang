	...
	public function dataList()
	{
        ...
        if(!empty($datas))
        {
            ...
            {  
            	...
            	if($this->data['is_can_edit'] && $data->is_deleted == 0 && $data->id > 2){
            		$edit_url = "<a href='".base_url()."role/edit/".$data->id."' class='btn btn-sm btn-info white'><i class='fa fa-pencil'></i> Edit</a>";
            	}  
            	if($this->data['is_can_delete'] && $data->id > 2){
