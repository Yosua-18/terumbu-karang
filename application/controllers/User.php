        ...
        { 
            ...
            {  
            	...
            	if($this->data['is_can_edit'] && $data->is_deleted == 0){
            		$edit_url = "<a href='".base_url()."user/edit/".$data->id."' class='btn btn-sm btn-info white'><i class='fa fa-pencil'></i> Edit</a>";
            	}  
                ...
                if(empty($data->photo)){
                	...
                	$nestedData['photo'] = "<img width='40px' src=".base_url()."uploads/profile/".$data->photo.">"; 
                }
